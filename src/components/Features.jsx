  ...
  return (
    <section className='bg-black pb-52 '>
        <div className='container mx-auto px-3 md:px-10'>
            ...
            Immerse yourself in a rich and ever-expanding universe where a vibrant array of prducts converge into interconnected overlay experience on your world.
            ...
            description="A new way to experience music, podcasts, and radio."
        ...
        <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
            ...
            <div className="bento-tilt_2 ">
                    <div className='flex size-full flex-col justify-betwenn bg-violet-300 p-5'>
